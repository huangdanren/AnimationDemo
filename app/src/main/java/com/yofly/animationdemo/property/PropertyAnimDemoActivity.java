...
public class PropertyAnimDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_property_anim_demo);
    ...
    private void doAnimation(Animator animator) {
        ...
        //仅在延迟阶段后才为true
        //animator.isRunning();
        //animator.start()后就返回true了，相当于isRunning()超集
        //animator.isStarted();
    }
...
//                    .before(getValueAnimator());
    ...
    private Animator getValueAnimatorByCustom() {
        ...
        valueAnimator.setInterpolator(new SpeedUp2Intepolator());
